...
const ProfileOnboarding: FunctionComponent = ({ children }) => {
    ...
    return (
        <>
            <Head>
                <title>สมัครสอบ GAT/PAT และ วิชาสามัญ</title>
            </Head>
            <section
            ...
            >
                ...
                <main
                    className={tw`flex flex-col-reverse md:flex-row gap-4 justify-between w-full`}
                >
                    <section
                    ...
                    >
                        ...
                        <Typography className={tw`mb-2 text-gray-500 dash`}>
                            รูปถ่ายหน้าตรงไม่สวมแว่นตาดำ ไม่สวมหมวก
                            หรือผ้าคลุมศีรษะใดๆ ยกเว้นผ้าคลุมทางศาสนา
                        </Typography>
                        <Typography className={tw`mb-2 text-gray-500 dash`}>
                            ห้ามตกแต่งภาพ หน้ามองตรง จมูก คิ้ว และปาก
                            จะต้องปรากฏบนภาพถ่าย พื้นหลังไม่มีลวดลาย
                        </Typography>
                        <Typography className={tw`mb-2 text-gray-500 dash`}>
                            ภาพถ่ายจะต้องครอบคลุมถึงศีรษะ และด้านบนของหัวไหล่
                            โดยให้เห็นใบหน้า 25% ของภาพถ่าย
                        </Typography>
                        <Typography className={tw`mb-2 text-gray-500 dash`}>
                            ถ่ายไว้ไม่เกิน 6 เดือน
                        </Typography>
                        <Typography className={tw`mb-2 text-gray-500 dash`}>
                            ขนาดไฟล์ไม่น้อยกว่า 40KB
                        </Typography>
                        <Typography className={tw`mb-2 text-gray-500 dash`}>
                            จนาดของรูปถ่าย 1 หรือ 1.5 นิ้ว
                        </Typography>
                        <Typography className={tw`mb-2 text-gray-500 dash`}>
                            ประเภทของไฟล์เป็น jpg หรือ png เท่านั้น
                        </Typography>
                    </section>
                </main>
